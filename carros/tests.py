...
class MySeleniumTest(LiveServerTestCase):
    ...
    def test_cadastrar(self):
        ...
        input_username.send_keys('brunaamamuito')
        input_password.send_keys('thiagopreto')
        input_repassword.send_keys('thiagopreto')
        sleep(1)
    ...
    def atualizar_produto(self): 
        ...
        browser.find_element(By.ID,'atualizar_carro').click() #id do botao de "atualizar produto"
        sleep(1)
